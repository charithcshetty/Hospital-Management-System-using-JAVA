...

{
 ...
 {int n;Double cha,hf,total,cb;String name;
	 Scanner input=new Scanner(System.in);
	 	System.out.println("------------------------------------------------------------------ \n "+"\t\t\t\tCITY HOSPITAL\n"+"------------------------------------------------------------------ "+"\t\t\t\t\t\n HOSPITAL BILL\n");
	 	System.out.println("Enter the name of the patient\n");
	 	name=input.nextLine();
	 	System.out.println("Enter the no of days admitted \n");
	 	n=input.nextInt();
	 	System.out.println("Enter the cost of bed in ward per day");
	 	cb=input.nextDouble();
	 	
	 	System.out.println("Enter the charge of treatment \n");
	 	cha=input.nextDouble();
	 	System.out.println("Enter the consultation fee \n");
	 	hf=input.nextDouble();
	 	total=(n*cb)+cha+hf;
	 	System.out.println("The bill generated for the patient "+name+" is ");
	 	System.out.println(total+" Rupees\n");
